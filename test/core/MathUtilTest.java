...
public class MathUtilTest {
   ...
   //viết code để test code chính bên kia!!!
    ...
    public void testGetFactorialGivenRightArgumentReturnsWell() {
        ...
        Assert.assertEquals(1, MathUtils.getFactorial(1)); //tui mún 1! == 1
        Assert.assertEquals(2, MathUtils.getFactorial(2)); //tui mún 2! == 2
        Assert.assertEquals(6, MathUtils.getFactorial(3)); //tui mún 3! == 6
        Assert.assertEquals(24, MathUtils.getFactorial(4)); //tui mún 4! == 24
        Assert.assertEquals(120, MathUtils.getFactorial(5)); //tui mún 5! == 120
        Assert.assertEquals(720, MathUtils.getFactorial(5)); //tui mún 6! == 720
...
//    
    ...
    public void testGetFactorialGivenWrongArgumentThrowsException() {
        MathUtils.getFactorial(-5);  //hàm @Test chạy, hay hàm getF() chạy
    }          
